...
const requireAuth = (req, res, next) => {
  ...
  if (!authHeader || !authHeader.startsWith('Bearer ')) {
    throw new HTTP_ERROR.UnauthorizedError('Missing access Token', ERR.AUTH_MISSING_ACCESS_TOKEN);
  }
  ...
  try {
    ...
    throw new HTTP_ERROR.UnauthorizedError('Invalid or expired token', ERR.AUTH_INVALID_TOKEN);
  }
}
