                ...
                {reports.map((report) => (
                    <div
                        ...
                        className={`p-4 cursor-pointer hover:bg-green-50 transition-colors
                            ${selectedId === report._id ? 'bg-green-50 border-l-4 border-green-600' : 'border-l-4 border-transparent'}
                        `}
                    >
                        ...
                        <p className="text-xs text-gray-500 mb-2">Từ: {report.reportedBy?.username || 'N/A'}</p>
